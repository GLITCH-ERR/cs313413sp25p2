...
public class TestList {
  ...
  public void setUp() throws Exception {
    ...
    //Using a LinkedList instead of an ArrayList affects performance but not
    //  functionality. LinkedList is better for frequent insertions/removals,
    //    while ArrayList is faster for random access due to contiguous memory
    //      storage.
  }
